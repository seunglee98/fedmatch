...
sets, developed by a team of matching enthusiasts at the Federal Reserve. It allows for a variety of different matching techniques, letting
...
As described in the manual for `clean_strings`, one can specify further arguments to remove words or try different replacements. Fedmatch comes with a set of words that are commonly used for this, but you can use whatever you'd like. 
